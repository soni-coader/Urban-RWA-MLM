    ...
    >
      <div className="w-full max-w-5xl">
        <h2 className="text-gradient md:text-6xl sm:text-4xl text-3xl font-bold mb-10 text-center">
          Privacy Policy – EMBOT
        </h2>

        <div className="space-y-8">
          <p className="font-medium md:text-[1.4rem] sm:text-lg md:leading-relaxed">
            At EMBOT, your privacy is our priority. This Privacy Policy explains
          ...
          <div>
            ...
            <p className="font-medium md:text-[1.4rem] sm:text-lg md:leading-relaxed">
              • To provide and improve EMBOT services. <br />
          ...
          <div>
            ...
            <p className="font-medium md:text-[1.4rem] sm:text-lg md:leading-relaxed">
              • EMBOT may use cookies to enhance your browsing experience. <br />
          ...
          <div>
            ...
            <p className="font-medium md:text-[1.4rem] sm:text-lg md:leading-relaxed">
              Our website may include links to third-party platforms. EMBOT is
